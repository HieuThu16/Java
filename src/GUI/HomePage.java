...
public class HomePage extends JFrame {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    frame.panelCustomer.add(new QuanLiSach_GUI2_JPanel());
    ...
    public HomePage() throws IOException {
        ...
        banHang.setBounds(0, 218, 193, 50);
        ...
        quanLiSach.setBounds(0, 278, 193, 50);
        ...
        btnCustomer.setBounds(0, 398, 193, 50);
        ...
        btnStatistics.setBounds(0, 646, 193, 50);
        ...
        btnChngTrnhGim.setBounds(0, 585, 193, 51);
        ...
        btnQunLNhn.setBounds(0, 338, 193, 50);
        ...
        btnNhpKho.setBounds(0, 525, 193, 50);
        ...
        btnChngTrnhGim_1.setBounds(0, 458, 193, 50);
            ...
            public void actionPerformed(ActionEvent e) {      
                panelCustomer.removeAll();
						try {
							...
							NhanVien_GUI2_Panel quanLiHoaDon = new NhanVien_GUI2_Panel();
							quanLiHoaDon.loadTableData();
