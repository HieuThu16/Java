...
public class QuanLiHoaDon_GUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					QuanLiHoaDon_GUI frame = new QuanLiHoaDon_GUI();
	 ...
	 * @throws SQLException 
	 */
	public QuanLiHoaDon_GUI() throws SQLException {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1264, 773);
		...
		table_hoaDon.addMouseListener(new MouseAdapter() {
		    public void mouseClicked(MouseEvent e) {
		        ...
		        if (selectedRow != -1) {
		            ...
		            ChiTietHoaDon_DAO dao = new ChiTietHoaDon_DAO(connection);
		            ArrayList<ChiTietHoaDon_DTO> chiTietList = null;
					try {
						chiTietList = dao.layDanhSachChiTietHoaDon(maHoaDon);
...
//					float tongTien = 0 ; 
//					try {
//						tongGiamGia = dao.tinhTongGiamGia(chiTietList);
//						tongDonGia = dao.tinhTongDonGia(chiTietList);
//						tongTien = tongDonGia - tongGiamGia ; 
//					} catch (Exception e1) {
//						// TODO Auto-generated catch block
//						e1.printStackTrace();
//					}
//					label_giamGia.setText(String.valueOf(tongGiamGia));
//					label_thanhTien.setText(String.valueOf(tongDonGia));
//					label_tongTien.setText(String.valueOf(tongTien));
		...
		table_chiTietHoaDon.addMouseListener(new MouseAdapter() {
		    public void mouseClicked(MouseEvent e) {	    	
		        ...
		        if (selectedRow != -1) {
		            ...
		            textField_maChiTietHoaDon.setText(model.getValueAt(selectedRow, 0).toString());
		            comboBox_maHoaDon.setSelectedItem(model.getValueAt(selectedRow, 1).toString());
		    	    ...
		    	    label_giamGia_1.setText(model.getValueAt(selectedRow, 6).toString());
		    	    label_tongTien_1.setText(model.getValueAt(selectedRow, 7).toString());
		...
		contentPane.add(label_demChiTiet);
		...
		contentPane.add(comboBox_maKhachHang_timKiem);
		comboBox_maKhachHang_timKiem.addItem("Tất cả");
		loadDataIntoComboBox_maKhachHang(comboBox_maKhachHang_timKiem);
		...
		button_sua.setBounds(157, 247, 100, 36);
		...
		button_sua.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        if (selectedRow != -1) {
		         ...
		         //       Date ngayLap = dateChooser_ngayLap.getDate(); // Lấy ngày từ JDateChooser
		                ...
		                // Tạo một đối tượng DTO mới với các giá trị đã thu thập
		                HoaDon_DTO hoaDon = new HoaDon_DTO(maHoaDon, maKhachHang.toString(), maNhanVien.toString(),
		                        maGiamGia.toString(), ngayLap, tongTien);
		                
		                // Gọi phương thức DAO để cập nhật dữ liệu
		                boolean updated = HoaDon_DAO.updateHoaDon(hoaDon);
		                if (updated) {
		...
		button_xoa.setBounds(374, 247, 100, 39);
	    ...
	    button_xoa.addActionListener(new ActionListener() {	 
	        public void actionPerformed(ActionEvent e) {
	            String maCTGG = label_maHoaDon.getText();
	            if (maCTGG.isEmpty()) {
	            ...
	            try {
	                hasDetails = HoaDon_DAO.hasDetails(maCTGG);
	            } catch (SQLException e1) {
	                e1.printStackTrace();
	            ...
	            if (confirm == JOptionPane.YES_OPTION) {
	                ...
	                deleted = HoaDon_DAO.deleteHoaDon(maCTGG);
	   ...
	   comboBox_maSach = new JComboBox<String>();
	    ...
	    textField_maChiTietHoaDon.setBounds(785, 252, 157, 27);
	    ...
	    contentPane.add(label_giamGia_1);
	    ...
	    contentPane.add(lblNewLabel_1_3_2_1_1_1);
	    
	    JLabel lblNewLabel_1_3_2_2 = new JLabel("Mã Chi Tiết Hóa Đơn");
	    lblNewLabel_1_3_2_2.setFont(new Font("Tahoma", Font.BOLD, 14));
	    lblNewLabel_1_3_2_2.setBounds(619, 248, 176, 30);
	    ...
	    contentPane.add(textField_maHoaDonTimKiem);
	    textField_maHoaDonTimKiem.setColumns(10);
	    
	    JButton button_tim = new JButton("Tìm");
	    button_tim.setBounds(894, 198, 113, 23);
	    ...
	    button_tim.addActionListener(new ActionListener() {
		    ...
		    private void searchAndDisplayFromDatabase(String maHoaDon, String maKhachHang ,
		        ...
		        try {
		            resultSet = HoaDon_DAO.searchAndDisplayFromDatabase(maHoaDon, maKhachHang,
	    ...
	    lblNewLabel_3.setBounds(980, 247, 135, 33);
	    contentPane.add(lblNewLabel_3);
	    
	    comboBox_maHoaDon = new JComboBox<String>();
	    comboBox_maHoaDon.setBounds(1096, 247, 136, 26);
	    ...
	    contentPane.add(lblNewLabel_1_3_2_1_1_1_1);
	    ...
	    contentPane.add(label_tongTien_1);
	    ...
	    contentPane.add(button_xoa_1);
	    button_xoa_1.addActionListener(new ActionListener() {	 
	        public void actionPerformed(ActionEvent e) {
	            String maChiTietHoaDon = textField_maChiTietHoaDon.getText();
	            ...
	            if (choice == JOptionPane.YES_OPTION) {
	                try {
	                    boolean deleted = ChiTietHoaDon_DAO.deleteChiTietHoaDon(maChiTietHoaDon);
	                    if (deleted) {
	                        Double tongTienHoaDon = HoaDon_DAO.calculateTotalBill(maHoaDon);
	                        boolean updated = HoaDon_DAO.updateTotalBill(maHoaDon, tongTienHoaDon);
	                        if (updated) {
	    ...
	    button_sua_1.addActionListener(new ActionListener() {
	        public void actionPerformed(ActionEvent e) {
	            ...
	            try {
	                ...
	                boolean updated = HoaDon_DAO.updateSoLuongChiTietHoaDon(maChiTietHoaDon, soLuongMoi , maHoaDon);
	                if (updated) {
	...
	public void loadTableData() throws SQLException {
	    ...
	    ArrayList<HoaDon_DTO> hoaDonList = hoaDonDao.layDanhSachHoaDon();
	...
	public void loadTableData_chitiet() throws SQLException {
	    ...
	    ChiTietHoaDon_DAO chitiet= new ChiTietHoaDon_DAO(connection);
	   
	    ArrayList<ChiTietHoaDon_DTO> chitiethoaDonList = chitiet.getAlldetailBills();

	    // Thêm dữ liệu hóa đơn vào bảng
	    for (ChiTietHoaDon_DTO hoaDon : chitiethoaDonList) {
	        model.addRow(new Object[] {
	        		hoaDon.getMaChiTietHoaDon(),
	 ...
	 private void loadDataIntoComboBox_maHoaDon(JComboBox<String> tenComboBox) throws SQLException {
