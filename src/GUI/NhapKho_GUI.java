...
public class NhapKho_GUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					NhapKho_GUI frame = new NhapKho_GUI();
	 ...
	 * @throws SQLException 
	 */
	public NhapKho_GUI() throws SQLException {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 1291, 770);
	  ...
	  JDateChooser dateChooser = new JDateChooser();
		...
		contentPane.add(textField_maChiTietPhieuNhap);
		...
		contentPane.add(comboBox_maNhaCungCap);
		...
		contentPane.add(comboBox_maNhaCungCap_TimKiem);
		...
		contentPane.add(label_tongTien_1_1);
		...
		contentPane.add(label_tongTien_1_2);
		...
		contentPane.add(jlabel_tongTien1);
		...
		contentPane.add(comboBox_maPhieuNhap);
		loadDataIntoComboBox_maPhieuNhap(comboBox_maPhieuNhap);
		...
		contentPane.add(label_soPhieuNhap);
		...
		contentPane.add(label_soChiTietPhieuNhap);
