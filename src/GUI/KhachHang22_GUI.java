...
public class KhachHang22_GUI extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					KhachHang22_GUI frame = new KhachHang22_GUI();
					frame.loadTableData();
	 ...
	 * Create the frame.
	 */
	public KhachHang22_GUI() {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(50, 50, 1257, 777);
		...
		contentPane.add(textField_maKhachHang);
		...
		contentPane.add(textField_hoKhachHang);
		...
		contentPane.add(textField_maKhachHang1);
		...
		contentPane.add(textField_hoKhachHang1);
		...
		contentPane.add(textField_tenKhachHang1);
		...
		button_sua.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			    ...
			    try {
			        ...
			        // Lấy ngày sinh từ JDateChooser và chuyển đổi sang định dạng yêu cầu
			        ...
			        boolean updated = KhachHang_DAO.updateSach(khachHang);
		...
		button_xoa.addActionListener(new ActionListener() {
		    ...
		    public void actionPerformed(ActionEvent e) {
		        ...
		        if (confirm == JOptionPane.YES_OPTION) {
		            boolean deleted = KhachHang_DAO.deleteSach(maKhachHang); // Gọi phương thức deleteSach để xóa khách hàng
		            if (deleted) {
	...
	btnNhp.setFont(new Font("Tahoma", Font.BOLD, 13));
        ...
        //String[] columnNames = {"Mã Khách Hàng", "Họ Khách Hàng", "Tên Khách Hàng", "Tổng Chi"};
        int[] columnIndices = {0, 1, 2, 6};
        ...
        contentPane.add(radioButton_nam_1);
        ...
        contentPane.add(radioButton_nu_1);
        ...
        contentPane.add(jlabel_tongChi);
	...
	public void loadTableData() {
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
        ArrayList<KhachHang_DTO> khachHangList = KhachHang_DAO.getAllEmployee();
 	 ...
 	 private static void searchAndDisplayFromDatabase(String maNhanVien, 
		...
		try {
			resultSet = KhachHang_DAO.searchAndDisplayFromDatabase(maNhanVien, 
 	...
 	private void sortTable(TableRowSorter<TableModel> sorter, int colIndex, int sortOrder) {
 	    int currentRowIndex = table.getSelectedRow();
 	    List<RowSorter.SortKey> sortKeys = new ArrayList<>();
 	    sortKeys.add(new RowSorter.SortKey(colIndex, sortOrder == 0 ? SortOrder.ASCENDING : SortOrder.DESCENDING));
 	    sorter.setSortKeys(sortKeys);
 	    sorter.sort();
 	    if (currentRowIndex >= 0 && currentRowIndex < table.getRowCount()) {
