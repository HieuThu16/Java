...
public class CTGG_GUI extends JFrame {
	...
	public CTGG_GUI() throws SQLException {
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(200, 50, 1273, 755);
		  ...
		  public void actionPerformed(ActionEvent e) {
		        ...
		        if (selectedRow != -1) {
		                ...
		                if (updated) {
		                    ...
		                    model.setValueAt(ngayBatDau, selectedRow, 2);
		                    model.setValueAt(ngayKetThuc, selectedRow, 3);
		...
		contentPane.add(textField_maCTCTGG);
		...
		contentPane.add(comboBox_maCTGG);
		...
		button_Sua1.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        try {
		            ...
		            // Gọi phương thức cập nhật từ lớp DAO
		            boolean updated = ChiTietCTGG_DAO.updateChiTietCTGG(ChiTietCTGG);
		...
		contentPane.add(label_soLuongChiTiet);
		...
		contentPane.add(label_soLuongGiamGia);
