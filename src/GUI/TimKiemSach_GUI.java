	...
	public TimKiemSach_GUI() {
		...
		table.addMouseListener(new MouseAdapter() {
		    public void mouseClicked(MouseEvent e) {
		        ...
		        HoaDon_GUI.setSachChoCombobox(maNhanVien);
		        CTGG_GUI.setSachChoCombobox(maNhanVien);
		        NhapKho_GUI.setSachChoCombobox(maNhanVien);
		    }
		});
		...
		button_tim.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        ...
		        if (minDonGia > maxDonGia) {
		        	...
		        	QuanLiSach_GUI.searchAndDisplayFromDatabase(valueMaSach,
		...
		comboBox_nhaXuatBan.addItem("Tất cả");
		QuanLiSach_GUI.loadDataIntoComboBox_maNhaXuatBan(comboBox_nhaXuatBan);
		...
		QuanLiSach_GUI.loadDataIntoComboBox_maTheLoai(comboBox_maTheLoai);
		...
		QuanLiSach_GUI.loadDataIntoComboBox_maTacGia(comboBox_maTacGia);
