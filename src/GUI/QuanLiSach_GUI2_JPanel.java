		    ...
		    public void actionPerformed(ActionEvent e) {
		        ...
		        if (selectedRow != -1) {
		            try {
		                ...
		                Sach_DTO sach = new Sach_DTO(maSach, maNXB.toString(), maTheLoai.toString(), maTacGia.toString(), tenSach, Integer.parseInt(namXuatBan), Integer.parseInt(soLuong), Double.parseDouble(donGia), hinhAnh);
